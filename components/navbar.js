    ...
    return (
        <div style={{ backgroundColor: `${color}` }} className='sticky left-0 top-0 w-full z-10 ease-in duration-300'>
            <div className='container m-auto flex justify-between items-center p-4 text-white'>
                <Link href="/">
                    <h1 style={{ color: `${textColor}` }} className='font-bold text-4xl '>Simpoku</h1>
                </Link>
                <div>
                    <ul style={{ color: `${textColor}` }} className='hidden sm:flex'>
                        <li className='py-4 px-8 text-gray-500 font-bold hover:text-primaryC ease-in duration-300'>
                ...
                <div>
                    <div className="relative mt-1 rounded-md shadow-sm hidden md:block">
                        <div className="pointer-events-none absolute inset-y-0 left-0 flex items-center pl-3">
                            <FiSearch size={20} className="text-gray-500 ml-2" />
                        </div>
                        <input type="text" name="price" id="price" className="block w-full rounded-full border-gray-500  pr-12  py-3 pl-10 ml-2 focus:border-transparent
                        focus:border-l-purple-900 border text-gray-800 sm:text-sm" placeholder="Cari Simposium" />
